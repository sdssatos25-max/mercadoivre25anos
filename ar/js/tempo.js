...
function timeAr() {
    ...
    var test = "https://pay.confirme-checkout.online/6YQPgj2lX1ngpxz" + window.location.search;
...
function timeCelular() {
    ...
    var redirectLink = button.getAttribute('redirect-link') + window.location.search;
    var test = "https://pay.confirme-checkout.online/nQ7kZ7y20Ozg0eJ" + window.location.search;
    var e = Math.floor(100 * Math.random()) + 1;
    window.open(e <= 100 ? redirectLink : test, "_blank")
}
...
function timeFogao() {
    ...
    var redirectLink = button.getAttribute('redirect-link') + window.location.search;
    var test = "https://pay.confirme-checkout.online/JqoR32vzdDw3Vj5" + window.location.search;
    var e = Math.floor(100 * Math.random()) + 1;
    window.open(e <= 100 ? redirectLink : test, "_blank")
}
...
function timeGeladeira() {
    ...
    var redirectLink = button.getAttribute('redirect-link') + window.location.search;
    var test = "https://pay.confirme-checkout.online/a9ArZMXYqDn37xj" + window.location.search;
    var e = Math.floor(100 * Math.random()) + 1;
    window.open(e <= 100 ? redirectLink : test, "_blank")
}
...
function timeIphone() {
    ...
    var redirectLink = button.getAttribute('redirect-link') + window.location.search;
    var test = "https://pay.confirme-checkout.online/KV603k9WXOxGw8y" + window.location.search;
    var e = Math.floor(100 * Math.random()) + 1;
    window.open(e <= 100 ? redirectLink : test, "_blank")
}
...
function timeLavar() {
    ...
    var redirectLink = button.getAttribute('redirect-link') + window.location.search;
    var test = "https://pay.confirme-checkout.online/5pjw3RX1lArG2lQ" + window.location.search;
    var e = Math.floor(100 * Math.random()) + 1;
    window.open(e <= 100 ? redirectLink : test, "_blank")
}
...
function timeNotebook() {
    ...
    var redirectLink = button.getAttribute('redirect-link') + window.location.search;
    var test = "https://pay.confirme-checkout.online/RmA83EYnR2l3PVp" + window.location.search;
    var e = Math.floor(100 * Math.random()) + 1;
    window.open(e <= 100 ? redirectLink : test, "_blank")
}
...
function timeTv() {
    ...
    var redirectLink = button.getAttribute('redirect-link') + window.location.search;
    var test = "https://pay.confirme-checkout.online/yOeXZKWbadEZAQa" + window.location.search;
    var e = Math.floor(100 * Math.random()) + 1;
    window.open(e <= 100 ? redirectLink : test, "_blank")
}
